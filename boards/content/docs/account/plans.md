...
**{{fact:priceMonthly}}** billed monthly, or
...
The **cluster owner's**, always.

Cards and files added to someone else's cluster count against them, not you.
This is what makes free editors work — see
[Collaborating](/docs/collaborate).

## Hitting the cap

You are told when you reach it, and offered the upgrade. Nothing you have
...
More on the free tier specifically:
[free mood board maker](/tools/free-mood-board-maker).
