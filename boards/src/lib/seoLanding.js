...
const PAGES = [
  ...
  },
  {
    ...
    // The only page that renders the live community-templates strip. The static
    // sections above are what the Worker serves and what crawlers read; the
    // strip is an enhancement layered on top, which is what keeps the two
