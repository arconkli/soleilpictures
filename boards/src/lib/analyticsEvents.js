...
export const EV = Object.freeze({
  ...
  CARD_CREATE_INTENT:      'card_create_intent',            // user did something that signals "make a card" {method,board_id} — method:'dblclick'|'dblclick_menu'|'add_menu'|'context_menu'|'tool_place'|'drag_in'|'paste'|'empty_cta'|'mobile_nav'. Fired BEFORE the mutator so a blocked create still has a preceding intent.
