...
export const EV = Object.freeze({
  ...
  UP_CHIP_VIEW:            'up_chip_view',                // demo topbar pill RENDERED {near,count,limit,pressure,elig_reason,cap_pct,price_shown} (logEventOnce per pageload). The chip had no impression row: "eligible and visible" could only be inferred from the ABSENCE of an up_suppressed row on that pageload, which is how a user parked at 92% of cap for eight days was misread as never having been asked
